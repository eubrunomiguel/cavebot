...
CaveBot.SuppliesWindow = nil
CaveBot.SuppliesWindow = UI.createWindow("SuppliesWindow")
CaveBot.SuppliesWindow:hide()
...
function CaveBot.Conversation(...)
    local expressions = {...}
    local delay = CaveBot.Config.get("talkDelay") or 1000
